...
class Track:
    def __init__(
        ...
        self.normals = n * (width / 2)
        self.normals_interp = interpolate_smooth(self.normals, fixed_number=center.shape[0])
        self.width_interp = interpolate_smooth(width, fixed_number=center.shape[0])
        ...
        self.left = left
        self.right = right
        self.left_growth = self.left.shape[0] / self.center.shape[0]
        self.right_growth = self.right.shape[0] / self.center.shape[0]
        self.left_growth = 1
        self.right_growth = 1
    ...
    def get_boundaries(
        ...
        width = self.width_interp[idx : idx + n_points]
